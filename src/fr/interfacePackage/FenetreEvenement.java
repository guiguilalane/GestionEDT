...
abstract class FenetreEvenement extends JDialog {
	...
	protected JTextField heureFinMinute = new JTextField("23",2);
	...
	public FenetreEvenement(JFrame parent, String title, boolean modal){
		...
		//On speÌ�cifie une taille
		this.setSize(380, 480);
		//La position
		this.setLocationRelativeTo(null);
		//La boiÌ‚te ne devra pas eÌ‚tre redimensionnable
		...
		JLabel heureDebLabel = new JLabel("Heure dÃ©but:");
		...
		// Parametre du champ CatÃ©gorie
		JLabel categorieLabel = new JLabel("CatÃ©gorie:");
		categorieEv.addItem("CM");
		categorieEv.addItem("TD");
		categorieEv.addItem("TP");
		categorieEv.addItem("ContrÃ´le Continu");
		...
		// Ajout des composants Ã  la grille
		elements.add(dateP);
